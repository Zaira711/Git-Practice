    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="productos.php" role="button" data-bs-toggle="dropdown" aria-expanded="false">Productos</a>
        ...
        <div class="row flex-lg-row-reverse align-items-center g-5 m-4"> 
            <div class="col-10 col-sm-8 col-lg-6"> 
                <img src="https://superate2014-my.sharepoint.com/:i:/g/personal/zaira_hernandez2027_adoc_superate_org/IQBrGoayl3vCRqigTgRJLMeiAWp5n56eJEmgSgBOoyDn5-c?e=f6W1JF" class="d-block mx-lg-auto img-fluid rounded-4" alt="Bootstrap Themes" width="700" height="500" loading="lazy"> 
            </div> 
            <div class="col-lg-6"> 
